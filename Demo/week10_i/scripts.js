/*
	...
	A função dentro da closure marca o produto como comprado e desactiva
	o botão de compra.
*/
...
(function () {
	...
	window.addEventListener('load', function () {
		...
		for (i = 0, end = produtos.length; i < end; ++i) {
			...
			// colocar id na linha do produto
			row.id = produtos[i].id;
			...
			(function (posActual) { // aqui ficam as variáveis "novas" para uso interno
				...
				btn.addEventListener('click', function () {
					// assinalar a linha do produto
					document.getElementById(produtos[posActual].id).className = 'selected';
